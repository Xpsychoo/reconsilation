...
export default function MapFieldsAs() {
            ...
            <div className=" col-xl-7 col-md-7 col-sm-12 col-12">
                ...
                <div className="row">
                    <div className="form-box">
                        <div className="row">
                            <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                                <label htmlFor="TanNO" className="form-label">TAN of Deductor
                    ...
                    <div className="form-box">
                        <div className="row">
                            <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                                <label htmlFor="partyName" className="form-label">Name of Deductor
                                    <span className="text-danger ms-1">*</span>
                                </label>
                            </div>
                            <div className="col-xl-5 col-md-5 col-sm-12 col-12">
                    ...
                    <div className="form-box">
                        <div className="row">
                            <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                                <label htmlFor="partyName" className="form-label">Status of Booking
                                    <span className="text-danger ms-1">*</span>
                                </label>
                            </div>
                            <div className="col-xl-5 col-md-5 col-sm-12 col-12">
